...
try:
    from agents.bias_auditor import BiasAuditor as _BiasAuditor
    from agents.credibility_engine import CredibilityEngine as _CredibilityEngine, Source as _Source
    from agents.forensic_engine import get_forensic_engine as _get_forensic_engine
    from agents.role_reversal_engine import RoleReversalEngine as _RoleReversalEngine
